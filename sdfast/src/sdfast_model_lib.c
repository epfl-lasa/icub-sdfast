...
} sdfast_model_gerror_t;
#define lasterr (sdfast_model_gerror.lasterr_)
#define lastrou (sdfast_model_gerror.lastrou_)

sdfast_model_gerror_t sdfast_model_gerror = {
/* Error parameters
*/
    /* lasterr */ 0,
    /* lastrou */ 0,
...
void sdfast_model_prerrmsg(FILE *fnum,
    int routine,
    int errnum)
{
    ...
    fprintf(fnum,"\n");
    if (routine == 1) {
        fprintf(fnum,"sdfast_model_grav:\n");
    }
    if (routine == 2) {
        fprintf(fnum,"sdfast_model_mass:\n");
    }
    if (routine == 3) {
        fprintf(fnum,"sdfast_model_iner:\n");
    }
    if (routine == 4) {
        fprintf(fnum,"sdfast_model_btj:\n");
    }
    if (routine == 5) {
        fprintf(fnum,"sdfast_model_itj:\n");
    }
    if (routine == 6) {
        fprintf(fnum,"sdfast_model_pin:\n");
    }
    if (routine == 7) {
        fprintf(fnum,"sdfast_model_init:\n");
    }
    if (routine == 8) {
        fprintf(fnum,"sdfast_model_state:\n");
    }
    if (routine == 9) {
        fprintf(fnum,"sdfast_model_psstate:\n");
    }
    if (routine == 13) {
        fprintf(fnum,"sdfast_model_presacc:\n");
    }
    if (routine == 14) {
        fprintf(fnum,"sdfast_model_presvel:\n");
    }
    if (routine == 15) {
        fprintf(fnum,"sdfast_model_prespos:\n");
    }
    if (routine == 10) {
        fprintf(fnum,"sdfast_model_hinget:\n");
    }
    if (routine == 11) {
        fprintf(fnum,"sdfast_model_pointf:\n");
    }
    if (routine == 12) {
        fprintf(fnum,"sdfast_model_bodyt:\n");
    }
    if (routine == 17) {
        fprintf(fnum,"sdfast_model_deriv:\n");
    }
    if (routine == 16) {
        fprintf(fnum,"sdfast_model_resid:\n");
    }
    if (routine == 18) {
        fprintf(fnum,"sdfast_model_pseudo:\n");
    }
    if (routine == 19) {
        fprintf(fnum,"sdfast_model_mom:\n");
    }
    if (routine == 20) {
        fprintf(fnum,"sdfast_model_sys:\n");
    }
    if (routine == 21) {
        fprintf(fnum,"sdfast_model_pos:\n");
    }
    if (routine == 22) {
        fprintf(fnum,"sdfast_model_vel:\n");
    }
    if (routine == 23) {
        fprintf(fnum,"sdfast_model_orient:\n");
    }
    if (routine == 24) {
        fprintf(fnum,"sdfast_model_angvel:\n");
    }
    if (routine == 25) {
        fprintf(fnum,"sdfast_model_trans:\n");
    }
    if (routine == 26) {
        fprintf(fnum,"sdfast_model_perr:\n");
    }
    if (routine == 27) {
        fprintf(fnum,"sdfast_model_verr:\n");
    }
    if (routine == 28) {
        fprintf(fnum,"sdfast_model_psqdot:\n");
    }
    if (routine == 29) {
        fprintf(fnum,"sdfast_model_psudot:\n");
    }
    if (routine == 30) {
        fprintf(fnum,"sdfast_model_getht:\n");
    }
    if (routine == 31) {
        fprintf(fnum,"sdfast_model_reac:\n");
    }
    if (routine == 32) {
        fprintf(fnum,"sdfast_model_acc:\n");
    }
    if (routine == 33) {
        fprintf(fnum,"sdfast_model_angacc:\n");
    }
    if (routine == 34) {
        fprintf(fnum,"sdfast_model_mult:\n");
    }
    if (routine == 35) {
        fprintf(fnum,"sdfast_model_aerr:\n");
    }
    if (routine == 36) {
        fprintf(fnum,"sdfast_model_indx:\n");
    }
    if (routine == 37) {
        fprintf(fnum,"sdfast_model_pres:\n");
    }
    if (routine == 38) {
        fprintf(fnum,"sdfast_model_stab:\n");
    }
    if (routine == 39) {
        fprintf(fnum,"sdfast_model_getgrav:\n");
    }
    if (routine == 40) {
        fprintf(fnum,"sdfast_model_getmass:\n");
    }
    if (routine == 41) {
        fprintf(fnum,"sdfast_model_getiner:\n");
    }
    if (routine == 42) {
        fprintf(fnum,"sdfast_model_getbtj:\n");
    }
    if (routine == 43) {
        fprintf(fnum,"sdfast_model_getitj:\n");
    }
    if (routine == 44) {
        fprintf(fnum,"sdfast_model_getpin:\n");
    }
    if (routine == 45) {
        fprintf(fnum,"sdfast_model_getpres:\n");
    }
    if (routine == 46) {
        fprintf(fnum,"sdfast_model_getstab:\n");
    }
    if (routine == 47) {
        fprintf(fnum,"sdfast_model_info:\n");
    }
    if (routine == 48) {
        fprintf(fnum,"sdfast_model_jnt:\n");
    }
    if (routine == 49) {
        fprintf(fnum,"sdfast_model_cons:\n");
    }
    if (routine == 50) {
        fprintf(fnum,"sdfast_model_assemble:\n");
    }
    if (routine == 51) {
        fprintf(fnum,"sdfast_model_initvel:\n");
    }
    if (routine == 52) {
        fprintf(fnum,"sdfast_model_static:\n");
    }
    if (routine == 53) {
        fprintf(fnum,"sdfast_model_steady:\n");
    }
    if (routine == 54) {
        fprintf(fnum,"sdfast_model_motion:\n");
    }
    if (routine == 55) {
        fprintf(fnum,"sdfast_model_fmotion:\n");
    }
    if (routine == 56) {
        fprintf(fnum,"sdfast_model_equivht:\n");
    }
    if (routine == 57) {
        fprintf(fnum,"sdfast_model_massmat:\n");
    }
    if (routine == 58) {
        fprintf(fnum,"sdfast_model_frcmat:\n");
    }
    if (routine == 59) {
        fprintf(fnum,"sdfast_model_rel2cart:\n");
    }
    if (routine == 60) {
        fprintf(fnum,"sdfast_model_comptrq:\n");
    }
    if (routine == 61) {
        fprintf(fnum,"sdfast_model_fulltrq:\n");
    }
    if (routine == 62) {
        fprintf(fnum,"sdfast_model_vrot:\n");
    }
    if (errnum == 1) {
    ...
    if (errnum == 22) {
        fprintf(fnum,"sdfast_model_init must be called first\n");
    }
    if (errnum == 23) {
        fprintf(fnum,"sdfast_model_state must be called first\n");
    }
    if (errnum == 24) {
        fprintf(fnum,"sdfast_model_deriv must be called first\n");
    }
    if (errnum == 25) {
...
void sdfast_model_error(int *routine,
    int *errnum)
{
...
void sdfast_model_printerr(FILE *fnum)
{
    ...
    sdfast_model_prerrmsg(fnum,lastrou,lasterr);
}
...
void sdfast_model_seterr(int routine,
    int errnum)
{
...
void sdfast_model_ldudcomp(int n,
    int na,
    int map[],
    double tol,
    double ld[],
...
void sdfast_model_ldubsl(int n,
    int na,
    int map[],
    double l[],
    double b[],
...
void sdfast_model_ldubsd(int n,
    int na,
    int map[],
    double d[],
    double b[],
...
void sdfast_model_ldubsu(int n,
    int na,
    int map[],
    double l[],
    double b[],
...
void sdfast_model_ldubslv(int n,
    int na,
    int map[],
    double work[],
    double l[],
    ...
    double x[])
{
    ...
    sdfast_model_ldubsl(n,na,map,l,b,work);
    sdfast_model_ldubsd(n,na,map,d,work,work);
    sdfast_model_ldubsu(n,na,map,l,work,x);
}

void sdfast_model_lduslv(int n,
    int na,
    int map[],
    double tol,
    double work1[],
    ...
    double x[])
{
    ...
    sdfast_model_ldudcomp(n,na,map,tol,work1,work2,m,l,d);
    sdfast_model_ldubslv(n,na,map,work2,l,d,b,x);
}
...
void sdfast_model_qrdcomp(int nr,
    int nc,
    int nra,
    int nca,
    int mapr[],
...
void sdfast_model_qrbslv(int nr,
    int nc,
    int nra,
    int nca,
    int mapr[],
    ...
    int *rank)
{
    ...
    if (k  !=  0) {
        sdfast_model_qrsl(nr,nc,nra,nca,mapr,mapc,k,work,w,qraux,b,x);
    }
    for (j = k; j <= nca-1; j++) {
        x[mapc[j]] = 0.;
    }
...
void sdfast_model_qrslv(int nr,
    int nc,
    int nra,
    int nca,
    int mapr[],
...
void sdfast_model_lsslv(int nr,
    int nc,
    int nra,
    int nca,
    int ndes,
...
/* Utility routines for use with sdfast_model_root. */


void sdfast_model_calcerrs(double fval[],
    int nfunc,
    int ndes,
    int dnorm,
    double *maxderr,
...
void sdfast_model_adjvars(int (*func)(),
    double vars[],
    double param[],
    int nfunc,
    int ndes,
    ...
    double newerrs[])
{
    ...
    *fcnt = *fcnt+1;
    ...
    sdfast_model_calcerrs(newerrs,nfunc,ndes,dnorm,&maxderr,&maxrerr,&derrnorm);
...
void sdfast_model_calcjac(int (*func)(),
    double vars[],
    double param[],
    int nfunc,
    int nvar,
...
void sdfast_model_root(int (*func)(),
    double vars[],
    double param[],
    int nfunc,
    int nvar,
    ...
    int *err)
{
    ...
    *fcnt = *fcnt+1;
    sdfast_model_calcerrs(fret,nfunc,ndes,dnorm,&pmaxderr,&pmaxrerr,&pderrnorm);
    crude = 1e-6;
                ...
                if ((pderrnorm > derrnorm) && (pmaxrerr <= rtol) && (maxrerr > 
                  rtol) && (maxrerr <= .05)) {
                    ...
                    for (fixits = 0; fixits < 5; fixits++) {
                        sdfast_model_calcjac(func,&rw[rvars]
...
/* Utility routine for use with sdfast_model_finteg and sdfast_model_vinteg.  Work is 2*neq. */


void sdfast_model_rk4m(int (*func)(),
    double time,
    double st[],
    double dst0[],
    double param[],
...
void sdfast_model_finteg(int (*func)(),
    double *time,
    double st[],
    double dst[],
    double param[],
...
void sdfast_model_vinteg(int (*func)(),
    double *time,
    double st[],
    double dst[],
    double param[],
    ...
    int *which)
{
    ...
    *err = 0;
    ...
    while (ttime  <  tfin) {
        ...
        nstp = stp;
        for (;;) {
            sdfast_model_rk4m(func,ttime,st,dst,param,nstp,&work[xst],neq,&work[
...
double 
sdfast_model_vdot(double ivec1[3],
    double ivec2[3])
{
    double dprod;
...
double 
sdfast_model_vnorm(double ivec[3])
{
    double norm;

/* Compute the length (norm) of a vector
*/
    norm = sqrt(sdfast_model_vdot(ivec,ivec));
    return norm;
}

void sdfast_model_vcopy(double ivec[3],
    double ovec[3])
{
...
void sdfast_model_vset(double sclr1,
    double sclr2,
    double sclr3,
    double ovec[3])
{
...
void sdfast_model_vadd(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void sdfast_model_vsub(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void sdfast_model_vmul(double sclr,
    double ivec[3],
    double ovec[3])
{
...
void sdfast_model_vaxpy(double sclr,
    double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void sdfast_model_vcross(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
    double tempout[3];
...
void sdfast_model_vrot(double ivec[3],
    double rvec[3],
    double theta,
    double ovec[3])
{
...
*/
    norm = sdfast_model_vnorm(rvec);
    if (norm == 0.) {
        ovec[0] = ivec[0];
        ovec[1] = ivec[1];
        ovec[2] = ivec[2];
        sdfast_model_seterr(62,46);
        return;
    }
    stheta = sin(theta);
    ctheta = cos(theta);
    sdfast_model_vmul(stheta,ivec,isinvec);
    sdfast_model_vmul(ctheta,ivec,icosvec);
    norm = 1./norm;
    sdfast_model_vmul(norm,rvec,uvec);
    idotu = sdfast_model_vdot(ivec,uvec);
    sdfast_model_vcross(uvec,isinvec,uxisin);
    dotcos = idotu*(1.-ctheta);
    sdfast_model_vaxpy(dotcos,uvec,icosvec,ovec);
    sdfast_model_vadd(ovec,uxisin,ovec);
}

void sdfast_model_serialno(int *serno)
{
